...
layout(location = 15) in vec2 diffuse_coord1;
layout(set = 0, binding = 9) uniform sampler2D diffuseTexture1;
#endif

#ifdef HAS_ambientTexture1
layout(location = 16) in vec2 ambient_coord1;
layout(set = 0, binding = 10) uniform sampler2D ambientTexture1;
#endif

#ifdef HAS_specularTexture1
layout(location = 17) in vec2 specular_coord1;
layout(set = 0, binding = 11) uniform sampler2D specularTexture1;
#endif

#ifdef HAS_emissiveTexture1
layout(location = 18) in vec2 emissive_coord1;
layout(set = 0, binding = 12) uniform sampler2D emissiveTexture1;
#endif

#ifdef HAS_emissiveTexture1
layout(location = 15) in vec2 emissive_coord1;
