...
public class GVRShader
{
    ...
    protected static String sTransformUBOCode =
            ...
            + "    view[3][0] = view[3][0] - (u_proj_offset * float(gl_ViewID_OVR));\n"
            + "    return view;\n}\n"
            + "mat4 calcInverseView()\n{\n"
            + "    mat4 iview = u_matrices[2];\n"
            + "    iview[0][3] = iview[0][3] - (u_proj_offset * float(gl_ViewID_OVR));\n"
            + "    return iview;\n}\n"
            + "#else\n"
            + "mat4 calcMVP()\n{\n"
            + "    mat4 mvp = u_matrices[u_matrix_offset];\n"
            ...
            + "mat4 calcView()\n{\n"
            + "    mat4 view = u_matrices[1];\n"
            + "    view[3][0] = view[3][0] - (u_proj_offset * float(u_right));\n"
            + "    return view;\n}\n"
            + "mat4 calcInverseView()\n{\n"
            + "    mat4 iview = u_matrices[2];\n"
            + "    iview[0][3] = iview[0][3] - (u_proj_offset * float(u_right));\n"
            + "    return iview;\n}\n"
            + "#endif\n";
